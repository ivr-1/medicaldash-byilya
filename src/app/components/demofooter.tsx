export default function DemoFooter () { 
    return (
        <footer className="flex flex-col items-center gap-3 my-1 opacity-70 ">
            ...
            <p className="text-sm font-semibold opacity-30">This is a demo website. All content, including medical information and user data, is fictional and for illustrative purposes only.</p>
        </footer>
    )
}